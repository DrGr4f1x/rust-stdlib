...
fn main() {
    ...
    // then remove it again with pop_front
    ...
    println!("A guest ordered mozzarella sticks!");
    orders.push_back("mozzarella sticks");
    ...
    // The rest of VecDeque's methods are
    // pretty much the same as Vec's
    // However VecDeque has additional options
    // when swap removing!
    ...
    // This is nearly the same, but swaps the removed
